(function () {
	...
	// ignored /home/kaqeebkhan/Desktop/my_custom_erpnext/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
	...
	frappe.ui.form.Timeline = class Timeline {
		...
		compare_dates(b, c) {
			...
			var comparison = frappe.datetime.str_to_obj(b_date) > frappe.datetime.str_to_obj(c_date) ? -1 : 1;
			return comparison;
		}
